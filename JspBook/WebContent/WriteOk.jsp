...
<body>
	<%
		...
		Statement stmt = null; //SQL 문장 처리 객체 (아직 메모리에 없음)
		...
		try {
			...
			out.print("디비연결OK<br>");
			stmt =conn.createStatement(); //쿼리용 객체 생성
			...
			sql += b_date + "','";
			sql += b_contents + "')";
// 			sql += "insert into board (b_subject,b_name,b_visit,b_date,b_contents) values ('" + b_subject + "','" + b_name + "',0,'" + b_date + "','" + b_contents + "')";
